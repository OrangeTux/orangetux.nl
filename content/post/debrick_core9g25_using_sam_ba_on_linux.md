...
Before you can write anything to the NAND flash the RAM most be initialized.
...
<!--Troubleshooting:-->
<!--When I also had minicom open.-->
<!--Opening serial port 'ttyUSB0'-->
<!--Error: Could not switch monitor on port 'ttyUSB0' to binary mode-->
<!--Connection closed.-->

<!--when you haven't remove short of bootpin-->
<!--Opening serial port 'ttyUSB0'-->
<!--Connection opened.-->
<!--Compatible device detected: SAM9G25.-->
<!--/home/auke/Downloads/sam-ba_3.2.1/qml/SAMBA/Applet.qml:232: Error: Could not initialize applet (status: 15)-->
<!--Connection closed.-->

<!--[usb-to-serial-cable]: https://www.conrad.nl/p/olimex-usb-serial-cable-f-developmentboard-1195115-->
